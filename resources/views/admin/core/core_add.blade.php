    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{route('admin.core.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-material">
                    {{csrf_field()}}
                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="name">نام هسته</label>
                            <div class="col-sm-6">
                                <input id="name" name="name" value="{{old('name')}}" placeholder="نام هسته"  class="form-control" type="text">
                                @if($errors->has('name'))
