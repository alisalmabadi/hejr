...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">ویرایش رشته </li>
        </ol>
    </section>
@endsection
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>ویرایش رشته </h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.field.update',$field)}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-material">
                    {{method_field('PATCH')}}
                    {{csrf_field()}}
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="name">نام رشته</label>
                        <div class="col-sm-6">
                            <input id="name" name="name" value="{{$field->name}}" placeholder="نام رشته"  class="form-control" type="text">
                            @if($errors->has('name'))
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="status">
                                <option @if($field->status==1) selected @endif value="1">فعال</option>
                                <option @if($field->status==0) selected @endif value="0">غیر فعال</option>
                            </select>
                        </div>
                    </div>
