    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>ایجاد پیام جدید</h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.message.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-material">
                    {{csrf_field()}}
                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="name">عنوان</label>
                            <div class="col-sm-6">
                                <input id="name" name="title" value="{{old('title')}}" placeholder="عنوان پیام"  class="form-control" type="text">
                                @if($errors->has('title'))
