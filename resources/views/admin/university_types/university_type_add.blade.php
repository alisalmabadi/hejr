...
@section('content-header')
    <section class="content-header">
        ...
        <h1>
            افزودن نوع دانشگاه جدید
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-bars"></i> نوع دانشگاه ها</a></li>
            <li class="active">ایجاد نوع دانشگاه جدید</li>
        </ol>
    </section>
@endsection
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>ایجاد نوع دانشگاه جدید</h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.university-type.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-material">
                    {{csrf_field()}}
                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="name">نام نوع دانشگاه</label>
                            <div class="col-sm-6">
                                <input id="name" name="name" value="{{old('name')}}" placeholder="نام نوع دانشگاه"  class="form-control" type="text">
                                @if($errors->has('name'))
