                        ...
                        <div class="col-sm-4">
                            <select  name="product_id" id="product_id" style="width: 100%;" class="form-control typesel" >
                                ...
                                @foreach($products as $product)
                                    <option value="{{$product->id}}"  @if($product->id==$article->product_id) selected @endif>{{$product->name}}</option>
                                @endforeach
                            </select>
                   ...
                   {{-- <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <img src="{{asset($article->img_thumbnail)}}" style="width:100px; height:100px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 text-center">
                            <div class="col-md-6" id="div_show_photos2">
                                <img src="{{asset($article->img)}}" style="width:100px; height:100px;">
                            </div>
                        </div>
                    </div>
                </form>
