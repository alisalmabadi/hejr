...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-th"></i>all events</li>
        </ol>
    </section>
@endsection
    ...
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i>event list</h3>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center">eventSubject</td>
                            ...
                            <td class="text-center">address point</td>
                        ...
                        @if(!empty($events))
                            @foreach($events as $event)
                                <tr>
                                    ...
                                    <td class="text-center">{{$event->end_date_signup}}</td>
