...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-bars"></i>موضوع رویداد</a></li>
            <li class="active">ویرایش موضوع رویداد</li>
        </ol>
    </section>
@endsection
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>ویرایش موضوع رویداد</h3>
            </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <select class="form-control" name="status">
                                ...
                                <option value="0" @if($event_subject->status == 0) sekected @endif>غیرفعال</option>
                            </select>
