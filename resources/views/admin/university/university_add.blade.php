...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">ایجاد دانشگاه جدید</li>
        </ol>
    </section>
@endsection
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>ایجاد دانشگاه جدید</h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.university.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-material">
                    {{csrf_field()}}
                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="name">نام دانشگاه</label>
                            <div class="col-sm-6">
                                <input id="name" name="name" value="{{old('name')}}" placeholder="نام دانشگاه"  class="form-control" type="text">
                                @if($errors->has('name'))
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="university_type_id">
                               @foreach($university_types as $university_type)
                                   <option value="{{$university_type->id}}">{{$university_type->name}}</option>
