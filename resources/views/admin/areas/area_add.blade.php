    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{route('admin.area.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-material">
                    {{csrf_field()}}
                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="name">شماره منطقه</label>
                            <div class="col-sm-6">
                                <input id="name" name="name" value="{{old('name')}}" placeholder="نام منطقه"  class="form-control" type="number">
                                @if($errors->has('name'))
