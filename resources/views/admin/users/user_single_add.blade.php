...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-bars"></i> عضو ها ها</a></li>
            <li class="active">ایجاد عضو جدید</li>
        </ol>
    </section>
@endsection
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{route('admin.user.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-material">
                    {{csrf_field()}}
