    ...
    <div class="m-content">
        <div class="row" style="background-color:white;">
            ...
            <form action="{{route('user.coreUsers.update', $user)}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-material">
                        ...
                        <label class="col-sm-6 control-label" for="keywords">انتخاب منطقه</label>
                            <select name="area" id="area" class="form-control" style="width: 100%" >
                                ...
                                @foreach($areas as $area)
                                    <option class="iranyekan" value="{{$area->id}}" @if($user->area_id == $area->id) selected @endif>{{$area->name}} منطقه </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-6 control-label" for="keywords">وضعیت تاهل</label>
                            <select name="martial" id="area" class="form-control" style="width: 100%" >
                                <option value="">انتخاب کنید.</option>
                                <option value="1" @if($user->martial ==1) selected @endif> متاهل</option>
                                <option value="0" @if($user->martial ==0) selected @endif>مجرد</option>
                            </select>
                        ...
                        <label class="col-sm-6 control-label" for="core_id">رشته</label>
                            <select id="field" class="form-control" name="field_id">
                                ...
                                {{--@foreach($fields as $field)
                                    <option value="{{$field->id}}" @if($user->field_id == $filed->id) selected @endif>{{$field->name}}</option>
                                @endforeach--}}
                            </select>
                        </div>
                    </div>
                        ...
                        <label class="col-sm-6 control-label" for="core_id">وضعیت نظام وظیفه</label>
                            <select id="soldier" class="form-control" name="soldier_service_id">
                                ...
                                @foreach($soldier_services as $soldier_service)
                                    <option value="{{$soldier_service->id}}" @if($user->soldier_service_id == $soldier_service->id) selected @endif>{{$soldier_service->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <input type="submit" class="form-control btn btn-success" value="به روز رسانی">
